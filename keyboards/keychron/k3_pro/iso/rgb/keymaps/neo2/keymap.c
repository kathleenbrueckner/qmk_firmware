...
[NEO_1] = LAYOUT_iso_85(
     KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,      KC_F12,   KC_PSCR,  KC_DEL,   RGB_TOG,
     DE_CIRC,  DE_1,     DE_2,     DE_3,     DE_4,     DE_5,     DE_6,     DE_7,     DE_8,     DE_9,     DE_0,     DE_MINS,     DE_GRV,   KC_BSPC,            KC_PGUP,
...
[NEO_2] = LAYOUT_iso_85(
     ...
     __TODO_,  DE_DEG,   DE_SECT,  UC(L'ℓ'), UC(L'»'), UC(L'«'), DE_DLR,   DE_EURO,  UC(L'„'), UC(L'“'), UC(L'”'), UC(L'—'),    _______,  _______,            _______,
...
[NEO_3] = LAYOUT_iso_85(
     _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,     _______,  _______,  _______,  _______,
     __TODO_,  UC(L'¹'), UC(L'²'), UC(L'³'), __TODO_,  __TODO_,  __TODO_, __TODO_,   __TODO_,  __TODO_,  __TODO_,  XXXXXXX,     __TODO_,  _______,            _______,
     _______,  __TODO_,  DE_UNDS,  DE_LBRC,  DE_RBRC,  DE_CIRC,  DE_EXLM,  DE_LABK,  DE_RABK,  DE_EQL,   DE_AMPR,  __TODO_,     __TODO_,  _______,            _______,
...
[NEO_4] = LAYOUT_iso_85(
     _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,     _______,  _______,  _______,  _______,
     __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,     __TODO_,  _______,            _______,
     _______,  KC_PGUP,  KC_BSPC,  KC_UP,    KC_DEL,   KC_PGDN,  __TODO_,  KC_KP_7,  KC_KP_8,  KC_KP_9,  DE_PLUS,  DE_MINS,     __TODO_,  _______,            _______,
     _______,  KC_HOME,  KC_LEFT,  KC_DOWN,  KC_RIGHT, KC_END,   __TODO_,  KC_KP_4,  KC_KP_5,  KC_KP_6,  DE_COMM,  DE_DOT,      _______,                      _______,
     _______,  _______,  KC_ESC,   KC_TAB,   __TODO_,  KC_ENT,   __TODO_,  KC_COLN,  KC_KP_1,  KC_KP_2,  KC_KP_3,  DE_SCLN,               _______,  _______,  _______,
     _______,  _______,  _______,                                KC_0,                                   _______,  _______,     _______,  _______,  _______,  _______),

[NEO_5] = LAYOUT_iso_85(
     _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,     _______,  _______,  _______,  _______,
     __TODO_,  UC(L'₁'), UC(L'₂'), UC(L'₃'), __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,     __TODO_,  _______,            _______,
     _______,  __TODO_,  XXXXXXX,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,     __TODO_,  _______,            _______,
     _______,  XXXXXXX,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,     _______,                      _______,
     _______,  XXXXXXX,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,               _______,  _______,  _______,
     _______,  _______,  _______,                                _______,                                _______,  _______,     _______,  _______,  _______,  _______),

[NEO_6] = LAYOUT_iso_85(
     _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,     _______,  _______,  _______,  _______,
     __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,     __TODO_,  _______,            _______,
     _______,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,     __TODO_,  _______,            _______,
     _______,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,     _______,                      _______,
     _______,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,  __TODO_,               _______,  _______,  _______,
     _______,  _______,  _______,                                _______,                                _______,  _______,     _______,  _______,  _______,  _______),
...
// Always activate numlock in order to make layer4 numbers work
